...
- 加入了 [IMBlocker(输入法冲突修复)](https://www.mcmod.cn/class/3358.html) Mod。
...
- 加入了 [森罗物语：厨房](https://www.mcmod.cn/class/20850.html) 的附属 Mod：[森罗物语：烟火](https://www.mcmod.cn/class/29020.html)。
  - 加入了烧烤玩法，并添加了一些作物和烤串以外的食物。
  - 现在，[森罗物语：厨房](https://www.mcmod.cn/class/20850.html) 和 [森罗物语：烟火](https://www.mcmod.cn/class/29020.html) 的食物都带有“热气腾腾”状态<del>锅气说是</del>；
    - 在“热气腾腾”状态下的食物会恢复更多饱食度；
    - “热气腾腾”状态会随着时间自然流逝逐渐失效，使用 [森罗物语：烟火](https://www.mcmod.cn/class/29020.html) 新增的几种油料可以延长“热气腾腾”的持续时间。
  - 科学部已完成对女仆的固件升级工作，教育部对机械臂和齿轮的自由式服从教育也已结业。
    - 现在，女仆会烤串了；
    - 机械动力生产线也会烤串！这是否意味着，机械手也可以是女仆？
  - <b>所有的</b>烤串都有食用动画，为什么？<span style="font-size:20px">因为我疯了！！！</span>
- 没了，又一次。

:::grid{columns="1"}
![意识到努力更新但服务器还是没人玩的我 be like:](/images/mcServer/wujing.jpg)
:::
...
- 加入了 [GD656击杀图标](https://www.mcmod.cn/class/21672.html) Mod。
  - 功能顾名思义，为 [永恒枪械工坊：零](https://www.mcmod.cn/class/14980.html) 与 [永无止境：载具](https://www.mcmod.cn/class/24495.html) 加入了击杀图标显示。
  - 击杀图标有多种风格，可自行调整，调整教程请见下文。
- 没了。
...
![点击“模式选择与元素配置”按钮](/images/mcServer/tutorial/g3.png)
